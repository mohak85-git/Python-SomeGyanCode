from id3tagsForMP3Files.id3_types import id3_field_encodings, apic_picture_types, frame_types
from os import SEEK_CUR, path
from typing import BinaryIO

filename = '../O6_FilesAndSerialization/O4_BinaryFiles/Someday.mp3'
